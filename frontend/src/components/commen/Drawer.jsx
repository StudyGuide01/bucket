...
const Drawer = () => {
  ...
  return (
    <>
      ...
      <div className="text-center bg-globalBlack flex items-center  justify-between px-4 py-2">
<div className="flex items-center justify-center space-x-5">
            <p className='text-white capitalize font-semibold text-3xl'>You Tube</p>
            <FaYoutube className="text-white text-5xl"/>
        </div>

       <div> 
         <IoMdMenu className="text-white text-2xl"   onClick={toggleDrawer} />
